                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-2">
                            ...
                            {request.status === 'pending' && (
                              <span className={`px-2 py-1 ${isDarkMode ? 'bg-orange-900/30 text-orange-300' : 'bg-orange-600 text-white'} rounded-full text-xs font-medium`}>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          {request.totalAmount && request.status === 'completed' && request.isPaid === true && (
                            <div className={`${isDarkMode ? 'bg-emerald-900/20' : 'bg-emerald-100'} px-3 py-2 rounded-lg flex flex-col items-end`}>
                              ...
                              <div className={`flex items-center space-x-1 ${isDarkMode ? 'bg-emerald-900/30 text-emerald-400' : 'bg-emerald-600 text-white'} px-2 py-1 rounded text-xs`}>
                                <DollarSign className="h-3 w-3 mr-1" />
