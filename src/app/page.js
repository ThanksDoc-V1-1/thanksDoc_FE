      ...
      <header className="container mx-auto px-4 py-6">
        <nav className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-gray-900">ThanksDoc</span>
          </div>
          <div className="hidden md:flex items-center space-x-6">
            <Link href="/admin/dashboard" className="text-gray-600 hover:text-blue-600 transition-colors">
              Admin Dashboard
            </Link>
            <Link href="/doctor/dashboard" className="text-gray-600 hover:text-blue-600 transition-colors">
              Doctor Dashboard
            </Link>
            <Link href="/business/dashboard" className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
              Business Dashboard
            </Link>
          </div>
        </nav>
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
            On-Demand <span className="text-blue-600">Healthcare</span>
            <br />
            for Your Business
          </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">Get connected with nearby doctors in minutes, not hours.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">All doctors are vetted and verified by our admin team.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">Designed specifically for pharmacies and healthcare businesses.</p>
            </div>
          </div>

          {/* How it Works */}
          <div className="mt-20">
            <h2 className="text-3xl font-bold text-gray-900 mb-12">How ThanksDoc Works</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">Request a Doctor</h3>
                <p className="text-gray-600">Business submits a request with urgency level and service type</p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">Doctor Responds</h3>
                <p className="text-gray-600">Nearby doctors receive notification and first responder gets the job</p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">Service Delivered</h3>
                <p className="text-gray-600">Doctor visits location, provides service, and payment is processed</p>
              </div>
            </div>
          </div>
        </div>
