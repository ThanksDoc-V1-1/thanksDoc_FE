        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex items-center justify-center space-x-2 mb-4">
              ...
              <h1 className="text-3xl font-bold text-white">Join as Doctor</h1>
            </div>
            <p className="text-gray-300">Create your profile to start receiving service requests</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="inline-flex items-center px-4 py-2 border border-blue-500 text-blue-400 bg-gray-800 rounded-lg hover:bg-gray-700 disabled:opacity-50"
                >
              ...
              <div className="pt-6">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-blue-800 text-white py-3 px-4 rounded-lg text-lg font-semibold hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-lg shadow-blue-900/50"
                >
              ...
              <div className="text-center text-sm text-gray-400">
                ...
                <Link href="/doctor/login" className="text-blue-400 hover:text-blue-300">
                  Login here
                </Link>
              </div>
            </form>
